...
var items = new vis.DataSet([
  {
    id: 0,
    content:
      '<div class="item-container"> <div class="item-text"><i class="fa-brands fa-youtube " style="color: #ff0000;"></i>  Primer Plan Quinquenal <br> Gobierno de Juan Domingo Perón </div><br> <img src="../assets/item-1.png"> </div>',
    start: "1947-01-05",
  },
  {
    id: 1,
    content:
      '<div class="item-container"> <div class="item-text"><i class="fa-solid fa-image " style="color: #26e33c;"></i>  Construcción de edificio <br> Radio Nacional Córdoba </div><br> <img src="../assets/item-2.png"> </div>',
    start: "1948-01-05",
  },
  {
    id: 2,
    content:
      '<i class="fa-solid fa-image" style="color: #26e33c;"></i>Compra de terrenos de Planta Transmisora en Toledo',
    start: "1950-01-05",
  },
]);
...
//AJUSTA EL ZOOM EN RESOLUCIÓNES MENORES A 576px
...
function ajustarZoomMax() {
  ...
  // Configurar zoomMax o disparar el clic en el botón en consecuencia
  if (anchoPantalla < 576) {
    // Si la pantalla es menor a 576px, configura zoomMax en el valor deseado
    timeline.setOptions({ zoomMax: zoomMaxPequeno });

    // Encuentra y dispara el clic en el botón #goToFirst
    var botonGoToFirst = document.getElementById("goToFirst");
    if (botonGoToFirst) {
      botonGoToFirst.click();
    }
  } else {
